const navbarHtml = `    <nav class="navbar" id="navbar">
        <div class="container">
            <a href="/" class="logo" style="display: flex; align-items: center; text-decoration: none;">
                <img src="/images/Logo_Ekalmad.jpeg" alt="Ekalmad Logo" style="height: 95px; width: auto; object-fit: contain; border-radius: 12px; box-shadow: 0 4px 6px rgba(0,0,0,0.15);">
            </a>
        ...
        <div class="container">
            ...
            <div class="footer-social">
                ...
                <div class="footer-social-icons">
                    <a href="https://youtube.com/@ekalmade.i.r.l?si=H10nqovH8kuvG5qv" target="_blank" rel="noopener noreferrer" class="social-icon social-youtube" aria-label="YouTube">
                    ...
                    <a href="https://www.tiktok.com/@ekalmad_e.i.r.l" target="_blank" rel="noopener noreferrer" class="social-icon social-tiktok" aria-label="TikTok">
                    ...
                    <a href="https://www.facebook.com/share/18FkCQmhQ2/" target="_blank" rel="noopener noreferrer" class="social-icon social-facebook" aria-label="Facebook">
